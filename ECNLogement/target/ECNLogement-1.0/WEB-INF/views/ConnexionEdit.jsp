...
<html>
  ...
  <body>
    ...
    <div class="py-5">
      <div class="container">
        <div class="row">
          <div class="col-md-12"><h3><fmt:message key="message.Connexion" bundle="${ressourcesBundle}"/></h3></div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <form method="POST">
              ...
              <input type="hidden" name="field" value="Connexion" />
              <div class="table-responsive">
                <table class="table table-striped table-sm ">
                  <tbody>
                    <tr>
                      <th scope="col"><fmt:message key="message.expiration" bundle="${ressourcesBundle}"/></th>
                      <td>
                        <input type="date" class="form-control" name="expiration" value="1" />
                      </td>
                    </tr>
                    <tr>
                  ...
                  <tfoot>
                    <tr id="save">
                      ...
                      <td class="text-center">
                        <button class="btn btn-warning" formaction="ConnexionList.do"><img src="img/cancel.png" alt="save" class="icon" /><fmt:message key="button.cancel" bundle="${ressourcesBundle}"/></button>
                        <button class="btn btn-success" formaction="ConnexionSave.do"><img src="img/save.png" alt="save" class="icon" /><fmt:message key="button.save" bundle="${ressourcesBundle}"/></button>
                      </td>
                    </tr>
                  </tfoot>
                </table>
