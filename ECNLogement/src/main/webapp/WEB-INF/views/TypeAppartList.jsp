  ...
  <body>
    ...
    <div class="py-5">
      <div class="container">
        <div class="row">
          <hr/>
          <div class="col-md-12"><h3><fmt:message key="message.TypeAppartList" bundle="${ressourcesBundle}"/></h3></div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="table-responsive">
               <div id="fountainG">
                ...
                <table id="TypeAppartList" class="table table-striped table-md sortable" style="visibility:hidden;">
                <thead>
                  <tr>
                ...
                <c:forEach var="item" items="${itemList}" varStatus="count">
                    ...
                    <td class="text-center">
                      ...
                      <input type="hidden" name="typeAppartNom" value="${item.typeAppartNom}">
                        <button class="btn btn-xs" formaction="TypeAppartEdit.do"><img src="img/edit.png" alt="edit" class="localButton" /></button>
                        <button class="btn btn-xs" formaction="TypeAppartRemove.do"><img src="img/delete.png" alt="delete" class="localButton" /></button>
                      </form>
                    </td>
                   </tr>
                </c:forEach>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            // addDataTableButtonImport("TypeAppart");
            // addDataTableButtonOther("TypeAppart", "buttonName", "actionName");
            addDataTableButtonNew("TypeAppart");
