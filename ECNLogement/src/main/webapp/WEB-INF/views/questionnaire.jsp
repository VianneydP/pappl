...
<html>
    ...
    <body>
        ...
        <div class="py-5">
            <div class="container col-md-10 align-items-center justify-content-center">
                <h1>Questionnaire</h1>
                <br>
                ...
                <br><hr/>
                <div class="container col-md-8 align-items-center justify-content-center">
                                ...
                                <div class="col-10">
                                    <div class="d-block">
                                        <div class="custom-control custom-radio">
                                            <input id="inputboursiernon" name="eleveBoursier" type="radio" class="custom-control-input" checked="" required="" value="non"> <label class="custom-control-label" for="inputboursiernon">Non</label>
                                        </div>
                                        <div class="custom-control custom-radio">
