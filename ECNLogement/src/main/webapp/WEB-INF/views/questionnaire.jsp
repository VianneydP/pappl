                        ...
                        <div class="col-10">
                            <div class="d-block my-3">
                                <div class="custom-control custom-radio">
                                    <input id="inputboursiernon" name="eleveBoursier" type="radio" class="custom-control-input" required="" value="non"> <label class="custom-control-label" for="inputboursionnon">Non</label>
                                </div>
                                <div class="custom-control custom-radio">
