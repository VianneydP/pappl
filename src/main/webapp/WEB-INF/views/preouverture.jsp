    ...
    <body>
        ...
        <div class="py-5">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="text-center"><fmt:message key="message.preouvertureDate" bundle="${ressourcesBundle}"/> ${dateDebut}</h1>
                        <h2 class="text-center"><fmt:message key="message.messagePreouverture" bundle="${ressourcesBundle}"/></h2>
