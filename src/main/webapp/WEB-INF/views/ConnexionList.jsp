  ...
  <body>
    ...
    <div class="py-5">
      <div class="container">
        <div class="row">
          <hr/>
          <div class="col-md-12"><h3><fmt:message key="message.ConnexionList" bundle="${ressourcesBundle}"/></h3></div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="table-responsive">
               <div id="fountainG">
                ...
                <table id="ConnexionList" class="table table-striped table-md sortable" style="visibility:hidden;">
                <thead>
                  <tr>
                    <th class="col-md-1"></th>
                    <th scope="col" col="col-md-2"></th>
                    <th scope="col" class="col-md-4"><fmt:message key="message.expiration" bundle="${ressourcesBundle}"/></th>
                    <th scope="col" class="col-md-4"><fmt:message key="message.personneNom" bundle="${ressourcesBundle}"/></th>
                    <th scope="col" class="col-md-4"><fmt:message key="message.personnePrenom" bundle="${ressourcesBundle}"/></th>
                    <th scope="col" class="col-md-4"><fmt:message key="message.roleId" bundle="${ressourcesBundle}"/></th>
                  </tr>
                </thead>
                ...
                <c:forEach var="item" items="${itemList}" varStatus="count">
                    ...
                    <td class="text-center">
                      ...
                      <input type="hidden" name="connectionId" value="${item.connectionId}">
                        <button class="btn btn-xs" formaction="ConnexionEdit.do"><img src="img/edit.png" alt="edit" class="localButton" /></button>
                        <button class="btn btn-xs" formaction="ConnexionRemove.do"><img src="img/delete.png" alt="delete" class="localButton" /></button>
                      </form>
                    </td>
                    <td class="text-left"><fmt:formatDate value="${item.expiration}" pattern="dd/MM/yyyy" /></td>
                ...
                <tfoot>
                  <tr>
                    <th></th>
                    <th></th>
                    <th id="sexpiration"><fmt:message key="message.expiration" bundle="${ressourcesBundle}"/></th>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            // addDataTableButtonImport("Connexion");
            // addDataTableButtonOther("Connexion", "buttonName", "actionName");
            addDataTableButtonNew("Connexion");
