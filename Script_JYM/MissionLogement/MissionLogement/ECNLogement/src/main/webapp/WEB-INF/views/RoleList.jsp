  ...
  <body>
    ...
    <div class="py-5">
      <div class="container">
        <div class="row">
          <hr/>
          <div class="col-md-12"><h3><fmt:message key="message.RoleList" bundle="${ressourcesBundle}"/></h3></div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="table-responsive">
               <div id="fountainG">
                ...
                <table id="RoleList" class="table table-striped table-md sortable" style="visibility:hidden;">
                <thead>
                  <tr>
                    <th class="col-md-1"></th>
                    <th scope="col" col="col-md-2"></th>
                    <th scope="col" class="col-md-9"><fmt:message key="message.roleNom" bundle="${ressourcesBundle}"/></th>
                  </tr>
                </thead>
                ...
                <c:forEach var="item" items="${itemList}" varStatus="count">
                    ...
                    <td class="text-center">
                      ...
                      <input type="hidden" name="roleId" value="${item.roleId}">
                        <button class="btn btn-xs" formaction="RoleEdit.do"><img src="img/edit.png" alt="edit" class="localButton" /></button>
                        <button class="btn btn-xs" formaction="RoleRemove.do"><img src="img/delete.png" alt="delete" class="localButton" /></button>
                      </form>
                    </td>
                    <td class="text-left">${item.roleNom}</td>
                   </tr>
                </c:forEach>
                </tbody>
                <tfoot>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            // addDataTableButtonImport("Role");
            // addDataTableButtonOther("Role", "buttonName", "actionName");
            addDataTableButtonNew("Role");
