  ...
  <body>
    ...
    <div class="py-5">
      <div class="container">
        <div class="row">
          <hr/>
          <div class="col-md-12"><h3><fmt:message key="message.CommuneList" bundle="${ressourcesBundle}"/></h3></div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="table-responsive">
               <div id="fountainG">
                ...
                <table id="CommuneList" class="table table-striped table-md sortable" style="visibility:hidden;">
                <thead>
                  <tr>
                    <th class="col-md-1"></th>
                    <th scope="col" col="col-md-2"></th>
                    <th scope="col" class="col-md-1"><fmt:message key="message.nomCommune" bundle="${ressourcesBundle}"/></th>
                    <th scope="col" class="col-md-1"><fmt:message key="message.codePostal" bundle="${ressourcesBundle}"/></th>
                    <th scope="col" class="col-md-1"><fmt:message key="message.latitude" bundle="${ressourcesBundle}"/></th>
                    <th scope="col" class="col-md-1"><fmt:message key="message.longitude" bundle="${ressourcesBundle}"/></th>
                    <th scope="col" class="col-md-1"><fmt:message key="message.dansMetropoleNantes" bundle="${ressourcesBundle}"/></th>
                  </tr>
                </thead>
                ...
                <c:forEach var="item" items="${itemList}" varStatus="count">
                    ...
                    <td class="text-center">
                      ...
                      <input type="hidden" name="codeCommune" value="${item.codeCommune}">
                        <button class="btn btn-xs" formaction="CommuneEdit.do"><img src="img/edit.png" alt="edit" class="localButton" /></button>
                        <button class="btn btn-xs" formaction="CommuneRemove.do"><img src="img/delete.png" alt="delete" class="localButton" /></button>
                      </form>
                    </td>
                    <td class="text-left">${item.nomCommune}</td>
                    <td class="text-left">${item.codePostal}</td>
                    <td class="text-left">${item.latitude}</td>
                    <td class="text-left">${item.longitude}</td>
                    <td class="text-left">${item.dansMetropoleNantes}</td>
                   </tr>
                </c:forEach>
                </tbody>
                <tfoot>
                  <tr>
                    <th></th>
                    <th></th>
                    <th id="snomCommune"><fmt:message key="message.nomCommune" bundle="${ressourcesBundle}"/></th>
                    <th id="scodePostal"><fmt:message key="message.codePostal" bundle="${ressourcesBundle}"/></th>
                    <th id="slatitude"><fmt:message key="message.latitude" bundle="${ressourcesBundle}"/></th>
                    <th id="slongitude"><fmt:message key="message.longitude" bundle="${ressourcesBundle}"/></th>
                    <th id="sdansMetropoleNantes"><fmt:message key="message.dansMetropoleNantes" bundle="${ressourcesBundle}"/></th>
                  </tr>
                </tfoot>
              </table>
            </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            // addDataTableButtonImport("Commune");
            // addDataTableButtonOther("Commune", "buttonName", "actionName");
            addDataTableButtonNew("Commune");
